...
<div id="work-collections" class="seaction">
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2022 <a class="grey-text text-lighten-4" href="https://Instagram.com/tofani_kanudo03" target="_blank">DARSHAN</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">DARSHAN</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
